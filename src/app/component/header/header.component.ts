      ...
      <div class="container-fluid px-3">
        ...
        >
          <div class="d-flex flex-column flex-lg-row mt-2 mt-lg-0">
            <span
              class="hover-tooltip"
              *ngIf="!isLoggedIn(); else loggedInBooksButton"
            >
              <a
                class="btn btn-outline-success me-lg-2 mb-2 mb-lg-0"
                routerLink="/bocker"
              >
                <i class="fas fa-book fa-lg me-2"></i>Mina böcker
              </a>
              <span class="tooltip-text">Du måste logga in</span>
            </span>

            <ng-template #loggedInBooksButton>
              <a
                class="btn btn-outline-success me-lg-2 mb-2 mb-lg-0"
                routerLink="/bocker"
              >
            ...
            <span
              class="hover-tooltip"
              *ngIf="!isLoggedIn(); else loggedInButton"
            >
              <a
                class="btn btn-outline-success me-lg-2 mb-2 mb-lg-0"
                routerLink="/quotes"
